...
Therefore, this data can be used to see if there's any trend, pattern, or relationship between these variables. I will do this with the help of tidyverse and magickpack via relevant code (finding min, max, or mean) and bar graphs. 

## **What I have found:**

The data shows that as the bus crowd level increases, the number of passengers not in their seats tends to increase.

The **minimum number** of passengers not at their seat is **0** for both mostly empty and moderate level, **1** for fairly crowded, **2** for crowded, and **7** for overcrowded.
...
The data also shows that as the bus vibe level changes (level increases), the number of passengers not being at their seat tends to increase. 

The **minimum number** of passengers not at their seat is **0** for average and quite/calm and **1** for fairly noisy bus vibe level.
